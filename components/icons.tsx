...
export const ShoppingCartIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c.51 0 .962-.343 1.087-.835l1.823-6.836a.75.75 0 00-.74-1.018H5.25w-1.5H3.75z" />
    </svg>
);
export const UsersIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.67c.625.93.998 2.028.998 3.145zM9 13.5a3 3 0 11-6 0 3 3 0 016 0zm-3-3a.75.75 0 000 1.5h.008a.75.75 0 000-1.5H6z" />
    </svg>
);
export const CreditCardIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3.375m-3.375 0c1.821 0 3.375-.984 3.375-2.25m0 0c0 .375.21.724.531.938m-1.433-4.281a3.75 3.75 0 014.242 0M11.25 12.75c.621 0 1.125-.504 1.125-1.125m-1.125 0c0-.621.504-1.125 1.125-1.125m0 0c.621 0 1.125.504 1.125 1.125m-1.125 0c0 .621-.504 1.125-1.125-1.125M12 3.75a.75.75 0 01.75.75v.008a.75.75 0 01-1.5 0V4.5a.75.75 0 01.75-.75z" />
    </svg>
);
...
export const UserGroupIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.284.126A3 3 0 017.5 15.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zM12.75 5.106a.75.75 0 01.75.75v4.5a.75.75 0 01-1.5 0v-4.5a.75.75 0 01.75-.75zM12 12a.75.75 0 00-.75.75v.008a.75.75 0 00.75-.75V12zm.75 2.25a.75.75 0 01.75.75v.008a.75.75 0 01-1.5 0v-.008a.75.75 0 01.75-.75z" />
    </svg>
);
...
export const GoogleIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px">
        ...
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.089,5.571l6.19,5.238C41.38,36.405,44,30.631,44,24C44,22.659,43.862,21.35,43.611,20.083z" />
    </svg>
);
...
export const PrinterIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.72 13.829c-.24.03-.48.062-.72.096m.72-.096a42.415 42.415 0 0110.56 0m-10.56 0L6.34 18m10.94-4.171c.24.03.48.062.72.096m-.72-.096L17.66 18M18 18v-2.775a.225.225 0 00-.225-.225H6.225a.225.225 0 00-.225.225V18m12 0a2.25 2.25 0 002.25-2.25V6.34a2.25 2.25 0 00-2.25-2.25H6.34a2.25 2.25 0 00-2.25 2.25v9.41A2.25 2.25 0 006.34 18m11.66 0h-1.66" />
  </svg>
);
...
export const BuildingStorefrontIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A.75.75 0 0114.25 12h.01a.75.75 0 01.75.75v7.5m-8.25-9.75h5.25a.75.75 0 01.75.75v9.75a.75.75 0 01-.75.75h-5.25a.75.75 0 01-.75-.75v-9.75a.75.75 0 01.75-.75z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 6.75a.75.75 0 01.75-.75h3a.75.75 0 01.75.75v3a.75.75 0 01-.75.75h-3a.75.75 0 01-.75-.75v-3z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.5h18m-18 0a9 9 0 019-9h.01a9 9 0 019 9m-18 0v-2.625a3.375 3.375 0 013.375-3.375h11.25a3.375 3.375 0 013.375 3.375V13.5" />
    </svg>
);
